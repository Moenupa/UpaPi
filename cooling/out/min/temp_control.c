...
int main(void)
{
	...
	while (1)
	{
		...
		//switch (count++)
		//{
		//	case 10: wiringPiI2CWriteReg8(fd_i2c, 0x04, 0x04); break;
		//	case 20: wiringPiI2CWriteReg8(fd_i2c, 0x04, 0x02); break;
		//	case 30: wiringPiI2CWriteReg8(fd_i2c, 0x04, 0x01); break;
		//	case 40: wiringPiI2CWriteReg8(fd_i2c, 0x04, 0x03); count=0; break;
		//}
		//delay(500);
	}
